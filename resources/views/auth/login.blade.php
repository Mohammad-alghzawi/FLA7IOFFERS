                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="{{ asset('assets/img/check.jpg') }}"
                                    alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; height:633px" />
                            </div>
                                ...
                                <div class="card-body p-3  text-black">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                           ...
                                           <img src="{{ asset('assets/img/sereen-removebg-preview.png') }}" width="30%" alt="">
                                        </div>
                                        ...
                                        <div class="pt-1 mb-4">
                                            ...
                                            <a href="{{ route('googlelogin') }}">
                                                <img src="{{ asset('assets/img/googlelogin.png') }}" style="height: 80px;width: 70%; margin-left: 60px; margin-top: 8px;" alt="photo55">
                                            </a>
